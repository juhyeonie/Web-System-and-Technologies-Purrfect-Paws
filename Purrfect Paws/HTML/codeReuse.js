...
class CSScaller extends HTMLElement {
     connectedCallback () {
        this.innerHTML = `
            ...
            <link rel="icon" href="../src/purrfect-pawslogo.png">
        `
     }
}
class wrapperMain extends HTMLElement {
    connectedCallback () {
        this.innerHTML = `
            <div class="wrapper">
                <div class="back-button">
                    <h2><a href="index.html">Home</a> > <a href="">` + HTMLTitle + `</a>
                </div>
            </div>
            `
    }
...
customElements.define('wrapper-main', wrapperMain)