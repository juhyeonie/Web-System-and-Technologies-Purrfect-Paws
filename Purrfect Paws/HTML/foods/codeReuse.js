...
class wrapperCatFood extends HTMLElement {
    connectedCallback () {
        this.innerHTML = `
                <div class="wrapper">
                    <div class="back-button">
                        <h2><a href="../index.html">Home</a> > <a href="../cat-foods.html">Cat Foods</a> > <a href="">` + HTMLTitle + `</a>
                    </div>
                </div>
...
class wrapperDogFood extends HTMLElement {
    connectedCallback () {
        this.innerHTML = `
            <div class="wrapper">
                <div class="back-button">
                    <h2><a href="../index.html">Home</a> > <a href="../dog-foods.html">Dog Foods</a> > <a href="">` + HTMLTitle + `</a>
                </div>
            </div>
                    `
    }
...
customElements.define('wrapper-cat', wrapperCatFood)
customElements.define('wrapper-dog', wrapperDogFood)